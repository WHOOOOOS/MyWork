...
/* ATK-MD0430模块LCD旋转方向枚举 */
typedef enum
{
    ATK_MD0430_LCD_DISP_DIR_0 = 0x00,           /* LCD顺时针旋转0°显示内容 */
...
/* ATK-MD0430模块LCD显示字体枚举 */
typedef enum
{
#if (ATK_MD0430_FONT_12 != 0)
    ATK_MD0430_LCD_FONT_12,             /* 12号字体 */
#endif
#if (ATK_MD0430_FONT_16 != 0)
    ATK_MD0430_LCD_FONT_16,             /* 16号字体 */
#endif
#if (ATK_MD0430_FONT_24 != 0)
    ATK_MD0430_LCD_FONT_24,             /* 24号字体 */
#endif
#if (ATK_MD0430_FONT_32 != 0)
    ATK_MD0430_LCD_FONT_32,             /* 32号字体 */
#endif
} atk_md0430_lcd_font_t;

/* ATK-MD0430模块LCD显示数字模式枚举 */
typedef enum
{
    ATK_MD0430_NUM_SHOW_NOZERO = 0x00,  /* 数字高位0不显示 */
...
/* 错误代码 */
#define ATK_MD0430_EOK          0   /* 没有错误 */
#define ATK_MD0430_ERROR        1   /* 错误 */
#define ATK_MD0430_EINVAL       2   /* 非法参数 */

/* 操作函数 */
uint8_t atk_md0430_init(void);                                                                                                                          /* ATK-MD0430模块初始化 */
uint16_t atk_md0430_get_lcd_width(void);                                                                                                                /* 获取ATK-MD0430模块LCD宽度 */
uint16_t atk_md0430_get_lcd_height(void);                                                                                                               /* 获取ATK-MD0430模块LCD高度 */
void atk_md0430_backlight_on(void);                                                                                                                     /* 开启ATK-MD0430模块LCD背光 */
void atk_md0430_backlight_off(void);                                                                                                                    /* 关闭ATK-MD0430模块LCD背光 */
void atk_md0430_display_on(void);                                                                                                                       /* 开启ATK-MD0430模块LCD显示 */
void atk_md0430_display_off(void);                                                                                                                      /* 关闭ATK-MD0430模块LCD显示 */
uint8_t atk_md0430_set_scan_dir(atk_md0430_lcd_scan_dir_t scan_dir);                                                                                    /* 设置ATK-MD0430模块LCD扫描方向 */
uint8_t atk_md0430_set_disp_dir(atk_md0430_lcd_disp_dir_t disp_dir);                                                                                    /* 设置ATK-MD0430模块LCD显示方向 */
...
void atk_md0430_draw_line(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, uint16_t color);                                                          /* ATK-MD0430模块LCD画线段 */
void atk_md0430_draw_rect(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, uint16_t color);                                                          /* ATK-MD0430模块LCD画矩形框 */
void atk_md0430_draw_circle(uint16_t x, uint16_t y, uint16_t r, uint16_t color);                                                                        /* ATK-MD0430模块LCD画圆形框 */
void atk_md0430_show_char(uint16_t x, uint16_t y, char ch, atk_md0430_lcd_font_t font, uint16_t color);                                                 /* ATK-MD0430模块LCD显示1个字符 */
void atk_md0430_show_string(uint16_t x, uint16_t y, uint16_t width, uint16_t height, char *str, atk_md0430_lcd_font_t font, uint16_t color);            /* ATK-MD0430模块LCD显示字符串 */
void atk_md0430_show_xnum(uint16_t x, uint16_t y, uint32_t num, uint8_t len, atk_md0430_num_mode_t mode, atk_md0430_lcd_font_t font, uint16_t color);   /* ATK-MD0430模块LCD显示数字，可控制显示高位0 */
void atk_md0430_show_num(uint16_t x, uint16_t y, uint32_t num, uint8_t len, atk_md0430_lcd_font_t font, uint16_t color);                                /* ATK-MD0430模块LCD显示数字，不显示高位0 */
void atk_md0430_show_pic(uint16_t x, uint16_t y, uint16_t width, uint16_t height, uint8_t *pic);                                                        /* ATK-MD0430模块LCD图片 */
